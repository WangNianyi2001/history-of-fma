...
2023年6月，#name[邱宸晨]接任社长，#name[戎晓雅]接任副社长。
...
五月底，经社内选举，#name[袁章埔]胜过#name[蒋昭宇]继任社长，后者任副社长。
...
2026 年春季学期，#link(<杂史:董跃夺实验室>)[董跃夺走了实验室]，FMA 失去了第二个稳定根据地。

叠纸联系到社团，希望以社团为单位组建人才库。
袁与其他管理成员讨论后，决定接下，并交给#name[朱程]办理。
...
#figure(
	...
	table(
		...
		[部门], [正], [副],
		table.hline(stroke: 0.5pt),
		[社长], [袁章埔“gxLight”（23 游技）], [蒋昭宇“滑稽”（22 电信）],
		[技术部], [王澍琪“pleasant233”（23 游技）], [李远哲（23 游技）],
		[艺术部], [刘正宽“小宽fly”（23 游技）], [-],
		[音乐部], [李周航“星渊Milky”（23 广电工）], [-],
		[游研部], [周溢轩“1god”（23 游技）], [-],
		[运营部], [宋思瑶“41”（23 视传）], [朱程（23 舆情） 张雨涵（非本校）],
		table.hline(stroke: 1pt),
	)
)
